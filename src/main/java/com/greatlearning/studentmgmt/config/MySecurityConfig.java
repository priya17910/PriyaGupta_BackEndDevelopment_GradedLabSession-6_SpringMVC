...
public class MySecurityConfig extends WebSecurityConfigurerAdapter {
	...
	public void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests().antMatchers("/students/list", "/students/showStudentFormForAdd", "/students/save")
				.hasAnyAuthority("ADMIN", "USER")
				.antMatchers("/students/showStudentFormForEdit/*", "/students/delete/*").hasAuthority("ADMIN")
